...
--
-- Host: localhost    Database: appBarCashDATABASE_URL_RAILWAY=mysql:
-- ------------------------------------------------------
...
--
-- Current Database: `appBarCashDATABASE_URL_RAILWAY=mysql:`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `appBarCashDATABASE_URL_RAILWAY=mysql:` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `appBarCashDATABASE_URL_RAILWAY=mysql:`;
